...
public class MainView extends javax.swing.JFrame {
    ...
    private void simpan() {
        ...
        if (gajiAyah == 4000000 && nilai == 75) {

            fieldUang.setText("Rp.5000.000");

        } else if (gajiAyah == 3000000 && ipk == 75) {

            fieldUang.setText("Rp.4000.000");

        } else if (gajiAyah == 2000000 && ipk == 70) {

            fieldUang.setText("Rp.3000.000");

        } else if (gajiAyah == 1000000 && ipk == 75) {
        ...
        try {
            String sql = "INSERT INTO siswa VALUES ('" + fieldNisn.getText() + "','" + fieldNama.getText() + "','" + fieldkelas.getSelectedItem() + "','" + fieldagama.getSelectedItem() + "','" + fieldAlamat.getText() + "','" + fieldjenis_kelamin.getSelectedItem() + "','" + fieldAyah.getText() + "','" + fieldGaji.getText() + "','" + fieldIpk.getText() + "','"  + "','" + fieldUang.getText() + "')";
    ...
    private void initComponents() {
        ...
        jLabel7.setText("A. Syarat dan ketentuan siswa yang menerima beasiswa :");

        jLabel18.setFont(new java.awt.Font("Dialog", 0, 13)); // NOI18N
        jLabel18.setForeground(new java.awt.Color(255, 255, 255));
        jLabel18.setText("1. Harus siswa aktif atau sedang menempuh jenjang persekolahan");

        jLabel25.setFont(new java.awt.Font("Dialog", 0, 13)); // NOI18N
        jLabel25.setForeground(new java.awt.Color(255, 255, 255));
        jLabel25.setText("2. siswa belum menerima beasiswa");

        jLabel26.setFont(new java.awt.Font("Dialog", 0, 13)); // NOI18N
        jLabel26.setForeground(new java.awt.Color(255, 255, 255));
        jLabel26.setText("3. siswa minimal harus memiliki nillai minimal 75");
        ...
        jLabel31.setText("3. Beasiswa Prestasi              : Rp. 4.500.000");
